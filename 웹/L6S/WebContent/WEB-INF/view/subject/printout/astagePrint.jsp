...
<!-- 	function openPop(){ -->
<%-- 		var url = '<c:url value="/subject/stage/popupprint/dstagePrint.do"/>'; --%>
<!-- 		alert(url); -->
...
<table>
	...
	<tr>
		<td>${a_form[0].title}</td>
		<td colspan="3">
		<input name="form_id" value="${a_form[0].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td>${a_form[1].title}</td>
		<td colspan="3">
		<input name="form_id" value="${a_form[1].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td rowspan="2">데이터수집</td>
		<td>${a_form[2].title }</td>
		<td>${a_form[3].title }</td>
		<td>${a_form[4].title }</td>
	</tr>
	<tr>
		<td>
		<input name="form_id" value="${a_form[2].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
		<td>
		<input name="form_id" value="${a_form[3].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
		<td>
		<input name="form_id" value="${a_form[4].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td>${a_form[5].title}</td>
		<td colspan="3">
		<input name="form_id" value="${a_form[5].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td>${a_form[6].title}</td>
		<td colspan="3">
		<input name="form_id" value="${a_form[6].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td width="25%" colspan="2">${a_form[7].title}</td>
		<td width="25%" colspan="2"><input type="file" name="file" size="30" ></td>
	</tr>
	<tr>
		<td width="25%" id="attachTitle" colspan="2">${a_form[8].title}</td>
		<td width="25%" id="attach" colspan="2">
			<input name="form_id" value="${a_form[8].form_id }" type="hidden">
			<input name="subkey" value=0 type="hidden">
