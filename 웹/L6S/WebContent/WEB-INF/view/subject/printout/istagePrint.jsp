...
<!-- 	function openPop(){ -->
<%-- 		var url = '<c:url value="/subject/printout/istagePrint.do"/>'; --%>
<!-- 		alert(url); -->
...
<table>
	...
	<tr>
		<td>${i_form[0].title}</td>
		<td colspan="4">
		<input name="form_id" value="${i_form[0].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td>${i_form[1].title}</td>
		<td colspan="4">
		<input name="form_id" value="${i_form[1].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td rowspan="2">단계요약</td>
		<td>${i_form[2].title}</td>
		<td>${i_form[3].title}</td>
		<td>${i_form[4].title}</td>
		<td>${i_form[5].title}</td>
	</tr>
	<tr>
		<td>
		<input name="form_id" value="${i_form[2].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
		<td>
		<input name="form_id" value="${i_form[3].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
		<td>
		<input name="form_id" value="${i_form[4].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
		<td>
		<input name="form_id" value="${i_form[5].form_id }" type="hidden">
		<input name="subkey" value=0 type="hidden">
		<input name="data" type="text"></td>
	</tr>
	<tr>
		<td width="25%" colspan="2">${i_form[6].title}</td>
		<td width="25%" colspan="3"><input type="file" name="file" size="30" ></td>
	</tr>
	<tr>
		<td width="25%" id="attachTitle" colspan="2">${i_form[7].title}</td>
		<td width="25%" id="attach" colspan="3">
			<input name="form_id" value="${i_form[7].form_id }" type="hidden">
			<input name="subkey" value=0 type="hidden">
