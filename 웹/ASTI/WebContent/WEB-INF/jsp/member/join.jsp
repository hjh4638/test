...
<form id="signupForm" class="cmxform" action="sign_up.do" method="POST">
	<table>
	<tr>
		<td> <label for="user_id">Email(ID 대용) </label></td><td> <label for="user_name">이름 </label> </td>
	</tr>
	<tr>	
	...
	<tr>
		...
		<td><label for="confirm_password">비밀번호(다시입력)</label></td>
	</tr>
	<tr>	
	...
	<tr>
		<td> <label for="com">회원사 </label></td><td> <button id="submitBtn" style="visibility:hidden;"></button> </td>
	</tr>
	<tr>	
