...
public class FacilitiesDao {
	...
	public List<VacationFacilitiesDTO> getFacilitiesList() throws SQLException{
		return sqlMapClientTemplate.queryForList("VacationFacilitiesSql.getFacilitiesList");
	}
	public void resetFacilities() throws SQLException{
		sqlMapClientTemplate.delete("VacationFacilitiesSql.resetFacilities");
	}
	public VacationFacilitiesDTO getOneOfFacilitiesById(Integer id) throws SQLException{
		return (VacationFacilitiesDTO) sqlMapClientTemplate.queryForObject("VacationFacilitiesSql.getOneOfFacilitiesById", id);
	}
	public void delFacilData(Integer id) throws SQLException{
		sqlMapClientTemplate.delete("VacationFacilitiesSql.delFacilData",id);
	}
	@SuppressWarnings("unchecked")
	public List<VacationFacilitiesDTO> getListOfFacilitiesByType(String type) throws SQLException{
